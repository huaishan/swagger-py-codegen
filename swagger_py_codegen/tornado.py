...
class Specification(Code):
    ...
    template = 'tornado/specification.tpl'
...
class Validator(Code):
    ...
    template = 'tornado/validators.tpl'
...
class TornadoGenerator(CodeGenerator):
    ...
    def _process_data(self):
        ...
        for paths, data in self.swagger.search(['paths', '*']):
            ...
            url, params = _swagger_to_tornado_url(swagger_path, data)
